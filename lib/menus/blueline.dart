...
class menu_4 extends StatefulWidget {
  menu_4({Key? key}) : super(key: key);
  static String id="menu_4";
  @override
  State<menu_4> createState() => _menuState();
}

class _menuState extends State<menu_4> {
  int count=0;
  late Map<String, int> cart_items= {'Crispy chilli baby corn': 0, 'Veg Manchurian dry ': 0, 'Veg Thali': 0};
