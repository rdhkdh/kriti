...
class menu_3 extends StatefulWidget {
  menu_3({Key? key}) : super(key: key);
  static String id="menu_3";
  @override
  State<menu_3> createState() => _menuState();
}

class _menuState extends State<menu_3> {
  int count=0;
  late Map<String, int> cart_items= {'Brownie': 0, 'Cold coffee ': 0, 'Cheese sandwich': 0};
  Map<String, int> menu= MenuList.menu_list_3;
  @override
