...
class menu_2 extends StatefulWidget {
  menu_2({Key? key}) : super(key: key);
  static String id="menu_2";
  @override
  State<menu_2> createState() => _menuState();
}

class _menuState extends State<menu_2> {
  int count=0;
  late Map<String, int> cart_items= {'Exotic Treat Pizza': 0, 'Butter Chilly Maggi': 0, 'Classic Veg Burger': 0};
