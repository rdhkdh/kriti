...
class core_stationery extends StatelessWidget {
  const core_stationery({Key? key}) : super(key: key);
  static String id='shop_2';
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Center(child: const Text('Core 1 Stationary')),
