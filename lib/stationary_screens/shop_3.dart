...
class dis_stationery extends StatelessWidget {
  const dis_stationery({Key? key}) : super(key: key);
  static String id='shop_3';
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Center(child: const Text('Disang Stationary')),
        ...
        children: [
          ...
          ButtonTheme(
            ...
            child: ElevatedButton(
              onPressed: () {_launchWhatsapp("+919365620975");},
